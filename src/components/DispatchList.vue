<template>
  <div>
    <el-table
      ...
      style="width: 100%"
    >
      <el-table-column prop="coneId" label="锥桶ID" width="130"> </el-table-column>
      <el-table-column prop="coneName" label="调度者用户名" width="120"> </el-table-column>
      <el-table-column
        prop="userFlag"
      ...
      ></el-table-column>
      <el-table-column prop="location" label="事故发生位置" width="160">
      </el-table-column>
      <el-table-column prop="batteryLeft" :formatter="formatscrapFlag" label="调度状态" width="80">
      </el-table-column>
